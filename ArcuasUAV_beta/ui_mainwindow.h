...
"background-color: rgb(0, 0, 0);"));
        ...
        B_1 = new QLabel(widget_Winch);
        B_1->setObjectName(QString::fromUtf8("B_1"));
        B_1->setGeometry(QRect(20, 400, 20, 20));
        B_1->setStyleSheet(QString::fromUtf8("border-radius: 10px;\n"
"border:3px groove gray;\n"
"border-style:outset;"));
        B_2 = new QLabel(widget_Winch);
        B_2->setObjectName(QString::fromUtf8("B_2"));
        B_2->setGeometry(QRect(60, 400, 20, 20));
        B_2->setStyleSheet(QString::fromUtf8("border-radius: 10px;\n"
"border:3px groove gray;\n"
"border-style:outset;"));
        label_11 = new QLabel(widget_Winch);
        label_11->setObjectName(QString::fromUtf8("label_11"));
        label_11->setGeometry(QRect(20, 430, 31, 20));
        label_12 = new QLabel(widget_Winch);
        label_12->setObjectName(QString::fromUtf8("label_12"));
        label_12->setGeometry(QRect(60, 430, 31, 20));
        label_13 = new QLabel(widget_Winch);
        label_13->setObjectName(QString::fromUtf8("label_13"));
        label_13->setGeometry(QRect(98, 430, 31, 20));
        SCL = new QLabel(widget_Winch);
        SCL->setObjectName(QString::fromUtf8("SCL"));
        SCL->setGeometry(QRect(98, 400, 20, 20));
        SCL->setStyleSheet(QString::fromUtf8("border-radius: 10px;\n"
"border:3px groove gray;\n"
"border-style:outset;"));
        SDA = new QLabel(widget_Winch);
        SDA->setObjectName(QString::fromUtf8("SDA"));
        SDA->setGeometry(QRect(140, 400, 20, 20));
        SDA->setStyleSheet(QString::fromUtf8("border-radius: 10px;\n"
"border:3px groove gray;\n"
"border-style:outset;"));
        label_14 = new QLabel(widget_Winch);
        label_14->setObjectName(QString::fromUtf8("label_14"));
        label_14->setGeometry(QRect(140, 430, 31, 20));
