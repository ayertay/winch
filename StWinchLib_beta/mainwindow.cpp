...
*/
    ...
    connect(mCore.p_taskWork,SIGNAL(signal_ShowCurrentIO(int,int)),this,SLOT(ON_ShowCurrentIO(int,int)));
...
{
    ui->lbl_PWM_duty->setText(QString::number(pwm_duty));
    ui->lbl_PWM_period->setText(QString::number(pwm_period));
}
